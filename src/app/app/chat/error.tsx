...
export default function ChatListError({
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-6 text-center">
      <h2 className="text-lg font-medium text-ink">Failed to load chats</h2>
      <p className="mt-2 text-sm text-muted">Something went wrong loading your conversations.</p>
      <button
        onClick={reset}
